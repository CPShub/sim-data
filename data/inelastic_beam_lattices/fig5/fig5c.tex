...
\begin{tikzpicture} 
    ...
    \node[draw, fill=black!10, right] at (axis cs: 0.15,16.9) {\large MSLA: BCC, $d=0.9$};
    
    \addplot[color=purple, dashed, ultra thick, mark=o, mark options={solid}, mark size=0, opacity=0.9, each nth point=20, forget plot]
    table[x expr=\thisrow{Weg}-0.0, y expr=\thisrow{Kraft}] {msla_bcc_d09_test_r0375_e45.txt};
     
    \addplot[color=purple, dashed, ultra thick, mark=o, mark options={solid}, mark size=0, opacity=0.9, each nth point=20] 
    table[x expr=\thisrow{Weg}-0.0, y expr=\thisrow{Kraft}] {msla_bcc_d09_test_r0375_e60.txt};
    ...
    table[x expr=\thisrow{lf}*4.5, y expr=\thisrow{fz}] {msla_bcc_d09_sim_r0375_e45.dat};
    
    \addplot[color=purple, solid, ultra thick, mark=o, mark options={solid}, mark size=0, opacity=0.9, each nth point=2] 
    table[x expr=\thisrow{lf}*6.0, y expr=\thisrow{fz}] {msla_bcc_d09_sim_r0375_e60.dat};
    ...
    table[x expr=\thisrow{Weg}-0.0, y expr=\thisrow{Kraft}] {msla_bcc_d09_test_r375_e45.txt};
    
    \addplot[color=MidnightBlue, dashed, ultra thick, mark=o, mark options={solid}, mark size=0, opacity=0.9, each nth point=20] 
    table[x expr=\thisrow{Weg}-0.0, y expr=\thisrow{Kraft}] {msla_bcc_d09_test_r375_e60.txt};
    ...
    table[x expr=\thisrow{lf}*4.5, y expr=\thisrow{fz}] {msla_bcc_d09_sim_r375_e45.dat};

    \addplot[color=MidnightBlue, solid, ultra thick, mark=o, mark options={solid}, mark size=0, opacity=0.9, each nth point=2] 
    table[x expr=\thisrow{lf}*6.0, y expr=\thisrow{fz}] {msla_bcc_d09_sim_r375_e60.dat};
